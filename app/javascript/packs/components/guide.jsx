    ...
    return(
      <div className='container'>
        ...
        <p className='margin-center max-width-650 center-align padding-25'>
          L'engagement civique est crucial. Vous pouvez donner votre avis sur l'avenir de votre ville durant des consultations publiques ou bien en utilisant ce site web initié par la municipalité de Nouméa. Votre participation peut influencer les futurs aménagements de votre ville, et en l'occurence la vision urbaine de l'entrée nord.
        </p>
        ...
        <img
          ...
          alt="Utiliser le site web suivant pour donner votre opinion sur la vision urbaine de l'entrée nord, organisée en 4 thématiques. Les commentaires et avis son analysés et représentés graphiquement afin de faciliter leur lecture et une meilleure prise de décision pour l'amélioration de Nouméa. Partagez ce site de concertation sur les réseaux sociaux Envoyez un message directement à l'architecte urbaniste"
        />
